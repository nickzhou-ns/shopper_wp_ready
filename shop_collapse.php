...
?>
<?php
include( "inc/shop_collapse/inc_header_shop_collapse.php" );
include( "inc/shop_collapse/inc_filters.php" );
include( "inc/shop_collapse/inc_filters_collapse.php" );
include( "inc/shop_collapse/inc_content_shop_collapse.php" );
?>
