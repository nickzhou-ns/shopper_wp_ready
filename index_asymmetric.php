...
include( "inc/common/inc_navbar_index_asymmetric.php" );

?>
	<?php
include( "inc/index_asymmetric/inc_welcome_index_asymmetric.php" );
include( "inc/index_asymmetric/inc_products_index_asymmetric.php" );
include( "inc/index_asymmetric/inc_sale_index_asymmetric.php" );
include( "inc/index_asymmetric/inc_must_haves_index_asymmetric.php" );
include( "inc/index_asymmetric/inc_features_index_asymmetric.php" );
?>
