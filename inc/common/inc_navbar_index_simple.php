<!-- NAVBAR -->
<nav  page="inc_navbar_index_simple"  class="navbar navbar-expand navbar-dark z-index_1">
  <div class="container"> 
    ...
    <!-- Toggler -->
    <button class="navbar-toggler d-block ms-7" type="button" data-bs-toggle="offcanvas" data-bs-target="#modalSidebar"> <span class="navbar-toggler-icon"></span> </button>
  </div>
</nav>
