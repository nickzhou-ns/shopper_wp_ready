    <!-- NAVBAR -->
    <nav  page="navbar_modals"  class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <ul class="navbar-nav mx-auto">
                ...
                <div class="card card-lg">
                  <div class="card-body">
                    <ul class="list-styled fs-sm">
                      ...
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./index_classic.php">Classic</a>
                      </li>
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./index_fashion.php">Fashion</a>
                      </li>
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./index_boxed.php">Boxed</a>
                      </li>
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./index_simple.php">Simple</a>
                      </li>
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./index_asymmetric.php">Asymmetric</a>
                      </li>
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./index_sidenav.php">Sidenav</a>
                      </li>
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./index_landing.php">Landing</a>
                      </li>
                    </ul>
                  </div>
                </div>
                        ...
                        <div class="container">
                          <div class="row">
                            ...
                            <div class="col-6 col-md">
                              ...
                              <ul class="list-styled mb-0 fs-sm">
                                <li class="list-styled-item">
                                  <a class="list-styled-link" href="./shop.php">All Collections</a>
                                </li>
                                <li class="list-styled-item">
                                  <a class="list-styled-link" href="./shop.php">Occasionwear</a>
                                </li>
                                <li class="list-styled-item">
                                  <a class="list-styled-link" href="./shop.php">Going Out</a>
                                </li>
                                <li class="list-styled-item">
                                  <a class="list-styled-link" href="./shop.php">Workwear</a>
                                </li>
                                <li class="list-styled-item">
                                  <a class="list-styled-link" href="./shop.php">Holiday Shop</a>
                                </li>
                                <li class="list-styled-item">
                                  <a class="list-styled-link" href="./shop.php">Jean Fit Guide</a>
                                </li>
                              </ul>
                            ...
                            <div class="col-4 d-none d-lg-block">
                              ...
                              <div class="card">
                                ...
                                <!-- Image -->
                                <img class="card-img" src="<?=get_template_directory_uri()?>/assets/img/products/product-110.jpg" alt="...">
              
                                <!-- Overlay -->
                                <div class="card-img-overlay bg-dark-0 bg-hover align-items-center">
                                  <div class="text-center">
                                    <a class="btn btn-white stretched-link" href="./shop.php">
                    ...
                    <div class="row">
                      <div class="col">
                        ...
                        <ul class="list-styled mb-7 fs-sm">
                          ...
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./shop_topbar.php">Topbar</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./shop_collapse.php">Collapse</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./shop_simple.php">Simple</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./shop_masonry.php">Masonry</a>
                          </li>
                        </ul>
                        ...
                        <ul class="list-styled fs-sm">
                          ...
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./product_images_left.php">Images Left</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="product_image_grid.php">Image Grid</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./product_image_slider.php">Image Slider</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="product_images_stacked.php">Images Stacked</a>
                          </li>
                        </ul>
                      ...
                      <div class="col">
                        ...
                        <ul class="list-styled mb-7 fs-sm">
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./shopping_cart.php">Shopping Cart</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./checkout.php">Checkout</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./order_completed.php">Order Completed</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./shipping_and_returns.php">Shipping & Returns</a>
                          </li>
                        </ul>
                        ...
                        <ul class="list-styled fs-sm">
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./account_order.php">Order</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./account_orders.php">Orders</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="account_wishlist.php">Wishlist</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="account_personal_info.php">Personal Info</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="account_address.php">Addresses</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./account_address_edit.php">Addresses: New</a>
                          </li>
                        </ul>
                      ...
                      <div class="col">
                        ...
                        <ul class="list-styled mb-7 fs-sm">
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="./account-payment.php">Payment</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="account_payment_edit.php">Payment: New</a>
                          </li>
                          <li class="list-styled-item">
                            <a class="list-styled-link" href="account_payment_choose.php">Payment: Choose</a>
                          </li>
                          <li class="list-styled-item">
                ...
                <div class="card card-lg">
                  <div class="card-body">
                    <ul class="list-styled fs-sm">
                      ...
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./contact_us.php">Contact Us</a>
                      </li>
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./store_locator.php">Store Locator</a>
                      </li>
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./faq.php">FAQ</a>
                      </li>
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./coming_soon.php">Coming Soon</a>
                      </li>
                      <li class="list-styled-item">
                ...
                <div class="card card-lg">
                  <div class="card-body">
                    <ul class="list-styled fs-sm">
                      ...
                      <li class="list-styled-item">
                        <a class="list-styled-link" href="./blog_post.php">Blog Post</a>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <li class="nav-item">
              <a class="nav-link" href="docs/getting_started.php">Docs</a>
            </li>
          </ul>
          ...
          <ul class="navbar-nav flex-row">
            ...
            <li class="nav-item ms-lg-n4">
              <a class="nav-link" href="account_wishlist.php">
