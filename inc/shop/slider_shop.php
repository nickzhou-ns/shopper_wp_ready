<!-- Slider -->
<div  page="slider_shop"  class="flickity-page-dots-inner mb-9" data-flickity='{"pageDots": true}'> 
      ...
      <div class="row align-items-center" style="min-height: 400px;">
        <div class="col-12 col-md-10 col-lg-8 col-xl-6">
          <div class="card-body px-md-10 py-11"> 
            ...
            <!-- Text -->
            <p class="mb-7"> Appear, dry there darkness they're seas. <br>
              <strong class="text-primary">Use code 4GF5SD</strong> </p>
            
            <!-- Button --> 
            <a class="btn btn-outline-dark" href="shop.php"> Shop Now <i class="fe fe-arrow-right ms-2"></i> </a> </div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row align-items-center" style="min-height: 400px;">
        <div class="col-12">
          <div class="card-body px-md-10 py-11 text-center text-white"> 
            ...
            <!-- Link --> 
            <a class="link-underline text-reset" href="shop.php">Shop Collection</a> </div>
        </div>
      </div>
    </div>
  </div>
