<!-- inc_WELCOME -->
<section page="inc_welcome" class="py-14" id="welcome" data-jarallax data-speed=".8" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/covers/cover-18.jpg);">
  <div class="container">
    <div class="row">
