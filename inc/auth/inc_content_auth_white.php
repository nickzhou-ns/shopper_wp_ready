<!-- CONTENT -->
<section  page="inc_content_auth_white" class="py-12">
  <div class="container">
    <div class="row">
            ...
            <form>
              <div class="row">
                ...
                <div class="col-12 col-md-auto"> 
                  ...
                  <!-- Link -->
                  <div class="form-group"> <a class="fs-sm text-reset" data-bs-toggle="modal" href="#modalPasswordReset">Forgot Password?</a> </div>
                </div>
                <div class="col-12"> 
                  
                  <!-- Button -->
                  <button class="btn btn-sm btn-dark" type="submit"> Sign In </button>
                </div>
              </div>
            </form>
          </div>
            ...
            <form>
              <div class="row">
                ...
                <div class="col-12"> 
                  ...
                  <!-- Email -->
                  <div class="form-group">
                    <label class="visually-hidden" for="registerEmail"> Email Address * </label>
                ...
                <div class="col-12 col-md-auto"> 
                  ...
                  <!-- Link -->
                  <div class="form-group fs-sm text-muted"> By registering your details, you agree with our Terms & Conditions,
                    and Privacy and Cookie Policy. </div>
                </div>
                <div class="col-12 col-md"> 
                  ...
                  <div class="form-group">
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="registerNewsletter"> Sign me up for the Newsletter! </label>
                    </div>
                  </div>
                </div>
                <div class="col-12"> 
