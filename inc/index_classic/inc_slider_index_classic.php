<!-- SLIDER -->
<section  page="inc_slider_index_classic" >
      ...
      <div class="container d-flex flex-column">
        <div class="row align-items-center py-12" style="min-height: 550px;">
          <div class="col-12 col-md-6 col-lg-5 col-xl-4 offset-md-1"> 
            ...
            <!-- Button --> 
            <a class="btn btn-dark" href="shop.php"> Shop Now <i class="fe fe-arrow-right ms-2"></i> </a> </div>
        </div>
      </div>
    </div>
      ...
      <div class="container d-flex flex-column">
        <div class="row align-items-center justify-content-end py-12" style="min-height: 550px;">
          <div class="col-12 col-md-6 col-lg-5 col-xl-4 offset-md-n1"> 
            ...
            <!-- Text -->
            <p class="mb-8 fs-lg text-gray-500"> So called give, one whales tree seas dry place own
              day, winged tree created spirit. </p>
        ...
        <div class="container d-flex flex-column">
          <div class="row align-items-center justify-content-end" style="min-height: 550px;">
            <div class="col-12 text-center text-white"> 
              ...
              <!-- Links -->
              <p class="mb-0"> <a href="shop.php" class="link-underline text-reset mx-4 my-4">Shop Women</a> <a href="shop.php" class="link-underline text-reset mx-4 my-4">Shop Men</a> </p>
            </div>
          </div>
        </div>
      </div>
