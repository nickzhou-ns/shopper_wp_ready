<!-- inc_CONTENT -->
<section page="inc_content_contact_us" class="pt-7 pb-12">
  <div class="container">
    <div class="row">
      <div class="col-12"> 
    ...
    <div class="row justify-content-between">
      <div class="col-12 col-md-4 col-xl-3">
        <aside class="mb-9 mb-md-0"> 
          ...
          <!-- Heading -->
          <h6 class="mb-6"> <i class="fe fe-phone text-primary me-4"></i> Call to Us: </h6>
          
          <!-- Text -->
          <p class="text-gray-500"> We're available from 10 am - 10 pm EST,
            7 days a week. </p>
          <p> <strong>Customer Service:</strong><br>
            <a class="text-gray-500" href="tel:60146-389-574">6-146-389-574</a> </p>
          <p class="mb-0"> <strong>Careers:</strong><br>
            <a class="text-gray-500" href="tel:60146-389-574">6-146-389-574</a> </p>
          ...
          <!-- Heading -->
          <h6 class="mb-6"> <i class="fe fe-mail text-primary me-4"></i> Write to Us: </h6>
          
          <!-- Text -->
          <p class="text-gray-500"> Fill out our form and we will contact you
            within 24 hours. </p>
          <p> <strong>Customer Service:</strong><br>
            <a class="text-gray-500" href="mailto:customer@example.com">customer@example.com</a> </p>
          <p class="mb-0"> <strong>Careers:</strong><br>
            <a class="text-gray-500" href="mailto:careers@example.com">careers@example.com</a> </p>
          
          <!-- Divider -->
          <hr>
          
          <!-- Heading -->
          <h6 class="mb-6"> <i class="fe fe-mail text-primary me-4"></i> Find Us: </h6>
          
          <!-- Text -->
          <p class="mb-0 text-gray-500"> Want to visit our Offline Stores? </p>
          
          <!-- Button -->
          <p class="mb-0"> <a class="btn btn-link px-0 text-body" href="store-locator.php"> Go to Store Locator <i class="fe fe-arrow-right ms-2"></i> </a> </p>
        </aside>
      </div>
