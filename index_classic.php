...
<!-- InstanceBeginEditable name="mian" -->
	<?php
include( "inc/common/inc_prmom_index_classic.php" );
include( "inc/common/inc_navbar_index_classic.php" );
?>
	<?php
include( "inc/index_classic/inc_slider_index_classic.php" );
include( "inc/index_classic/inc_categories_index_classic.php" );
include( "inc/index_classic/inc_categories_2.php" );
include( "inc/common/inc_products_index.php" );
include( "inc/index_classic/inc_arrivals.php" );
include( "inc/index_classic/inc_arrivals_2.php" );
include( "inc/index_classic/inc_blog_index_classic.php" );
